"""v18: Original .pt at 6 scales + latest copy-paste ONNX.
Maximizes runtime usage.
"""
import argparse
import json
...
def main():
    ...
    for img_path in sorted(Path(args.input).iterdir()):
        ...
        # Model A (.pt) at 6 scales
        for imgsz, conf, wt in [
            (640, 0.03, 0.5), (800, 0.02, 0.8), (960, 0.02, 1.0),
            (1088, 0.015, 1.2), (1280, 0.01, 2.0), (1440, 0.01, 1.2),
        ]:
